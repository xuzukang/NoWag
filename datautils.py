...
def get_wikitext2(nsamples_train,nsamples_val, seed, seqlen, model, tokenizer):
    ...
    return trainloader, valloader, testenc

def get_ptb(nsamples_train, nsamples_val, seed, seqlen, model, tokenizer):
...
def get_loaders(name, nsamples_train=128, nsamples_val=16, seed=0, seqlen=2048, model=''):
    ...
    if 'c4' in name:
        return get_c4(nsamples_train, nsamples_val, seed, seqlen, model, tokenizer)
