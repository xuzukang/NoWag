...
sparse_checkpoints_path = (
    f"/data/lliu/huffman/models/{model_name}/compressed/150/checkpoints.yaml"
)
sparse_checkpoints = yaml.load(
    open(sparse_checkpoints_path, "r"), Loader=yaml.FullLoader
)

non_sparse_checkpoints_path = (
    f"/data/lliu/huffman/models/{model_name}/compressed/166/checkpoints.yaml"
)
non_sparse_checkpoints = yaml.load(
    open(non_sparse_checkpoints_path, "r"), Loader=yaml.FullLoader
)
